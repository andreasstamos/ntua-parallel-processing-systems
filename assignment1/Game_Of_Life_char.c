...
unsigned char ** allocate_array(int N);
void free_array(unsigned char ** array, int N);
void init_random(unsigned char ** array1, unsigned char ** array2, int N);
#ifdef OUTPUT
...
int main (int argc, char * argv[]) {
	...
	int T; 				//time steps
	unsigned char ** current, ** previous; 	//arrays - one for current timestep, one for previous timestep
	unsigned char ** swap;			//array pointer
